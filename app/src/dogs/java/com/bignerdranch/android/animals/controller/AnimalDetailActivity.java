...
public class AnimalDetailActivity extends AppCompatActivity {
    private static final String EXTRA_GALLERY_ITEM = "AnimalDetailActivity.GALLERY_ITEM";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        GalleryItem galleryItem = (GalleryItem) getIntent().getSerializableExtra(EXTRA_GALLERY_ITEM);

        if (savedInstanceState == null) {
            AnimalDetailFragment fragment = AnimalDetailFragment.newInstance(galleryItem);
